  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="img/banner3.jpg" alt="Los Angeles" style="width:100%; height:20%">
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					$product_query = "SELECT * FROM products,categories WHERE product_cat=cat_id AND product_id BETWEEN 40 AND 70";
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					$product_query = "SELECT * FROM products,categories WHERE product_cat=cat_id AND product_id BETWEEN 9 AND 20";
                $run_query = mysqli_query($con,$product_query);
                if(mysqli_num_rows($run_query) > 0){
