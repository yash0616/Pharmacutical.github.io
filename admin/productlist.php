	...
	<a class=" btn btn-primary" href="addproduct.php">Add New</a></th></tr></thead>
                    <tbody>
                      <?php 
                        ...
                        $result=mysqli_query($con,"select product_id,product_image, product_title,product_price from products  where 
                        product_cat=1 or 
                        product_cat=2 or product_cat=3 or product_cat=4 or
                        product_cat=5 or
                        product_cat=6 or
                        product_cat=7 Limit $page1,12")or die ("query 1 incorrect.....");
                        ...
                        <a href='editproducts.php?product_id=$product_id' type='button' rel='tooltip' title='' class='btn btn-info btn-link btn-sm' data-original-title='Edit Product'>
                                <i class='material-icons'>edit</i>
                              <div class='ripple-container'></div></a>

                        <a class=' btn btn-success' href='productlist.php?product_id=$product_id&action=delete' type='button' rel='tooltip' title=''>Delete</a>
                        </td></tr>";
